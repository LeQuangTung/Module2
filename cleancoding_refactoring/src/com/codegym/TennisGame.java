...
public class TennisGame {
    public static String getScore(String player1Name, String player2Name, int player1_score, int player2_score) {
        return checkWinner(player1_score, player2_score);
    }

    private static String checkWinner(int player1_score, int player2_score) {
        String score = "";
        int tempScore=0;
        boolean checkdraw = player1_score == player2_score;
        if (checkdraw) {
            ...
            boolean checkWin = (player1_score >= 4 || player2_score >= 4);
            if (checkWin) {
